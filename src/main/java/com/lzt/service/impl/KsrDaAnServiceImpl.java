...
public class KsrDaAnServiceImpl implements KsrDaAnService {
	...
	public FenShuVo submitDaAn(KsrDaAnVo ksrDaAnVo) {
		...
		Map<String,Object> mapXz2 = makeKDA(sjId,ksrDaAnVo.getXzQuestId2(),ksrDaAnVo.getXzContent2(),"1",2);
		KsrDaAn xz2 = (KsrDaAn)mapXz2.get("kda");
		FenShuVo xzFsv2= (FenShuVo)mapXz2.get("fsv");
		Map<String,Object> mapXz3 = makeKDA(sjId,ksrDaAnVo.getXzQuestId3(),ksrDaAnVo.getXzContent3(),"1",3);
		KsrDaAn xz3 = (KsrDaAn)mapXz3.get("kda");
		FenShuVo xzFsv3= (FenShuVo)mapXz3.get("fsv");
		Map<String,Object> mapXz4 = makeKDA(sjId,ksrDaAnVo.getXzQuestId4(),ksrDaAnVo.getXzContent4(),"1",4);
		KsrDaAn xz4 = (KsrDaAn)mapXz4.get("kda");
		FenShuVo xzFsv4= (FenShuVo)mapXz4.get("fsv");
		Map<String,Object> mapXz5 = makeKDA(sjId,ksrDaAnVo.getXzQuestId5(),ksrDaAnVo.getXzContent5(),"1",5);
		KsrDaAn xz5 = (KsrDaAn)mapXz5.get("kda");
		FenShuVo xzFsv5= (FenShuVo)mapXz5.get("fsv");
		Map<String,Object> mapXz6 = makeKDA(sjId,ksrDaAnVo.getXzQuestId6(),ksrDaAnVo.getXzContent6(),"1",6);
		KsrDaAn xz6 = (KsrDaAn)mapXz6.get("kda");
		FenShuVo xzFsv6= (FenShuVo)mapXz6.get("fsv");
		Map<String,Object> mapXz7 = makeKDA(sjId,ksrDaAnVo.getXzQuestId7(),ksrDaAnVo.getXzContent7(),"1",7);
		KsrDaAn xz7 = (KsrDaAn)mapXz7.get("kda");
		FenShuVo xzFsv7= (FenShuVo)mapXz7.get("fsv");
		Map<String,Object> mapXz8 = makeKDA(sjId,ksrDaAnVo.getXzQuestId8(),ksrDaAnVo.getXzContent8(),"1",8);
		KsrDaAn xz8 = (KsrDaAn)mapXz8.get("kda");
		FenShuVo xzFsv8= (FenShuVo)mapXz8.get("fsv");
		Map<String,Object> mapXz9 = makeKDA(sjId,ksrDaAnVo.getXzQuestId9(),ksrDaAnVo.getXzContent9(),"1",9);
		KsrDaAn xz9 = (KsrDaAn)mapXz9.get("kda");
		FenShuVo xzFsv9= (FenShuVo)mapXz9.get("fsv");
		Map<String,Object> mapXz10 = makeKDA(sjId,ksrDaAnVo.getXzQuestId10(),ksrDaAnVo.getXzContent10(),"1",10);
		KsrDaAn xz10 = (KsrDaAn)mapXz10.get("kda");
		FenShuVo xzFsv10= (FenShuVo)mapXz10.get("fsv");
		
		Map<String,Object> mapWd1 = makeKDA(sjId,ksrDaAnVo.getWdQuestId1(),ksrDaAnVo.getWdContent1(),"2",11);
		KsrDaAn wd1 = (KsrDaAn)mapWd1.get("kda");
		FenShuVo wdFsv1= (FenShuVo)mapWd1.get("fsv");
		Map<String,Object> mapWd2 = makeKDA(sjId,ksrDaAnVo.getWdQuestId2(),ksrDaAnVo.getWdContent2(),"2",12);
		KsrDaAn wd2 = (KsrDaAn)mapWd2.get("kda");
		FenShuVo wdFsv2= (FenShuVo)mapWd2.get("fsv");
		Map<String,Object> mapWd3 = makeKDA(sjId,ksrDaAnVo.getWdQuestId3(),ksrDaAnVo.getWdContent3(),"2",13);
		KsrDaAn wd3 = (KsrDaAn)mapWd3.get("kda");
		FenShuVo wdFsv3= (FenShuVo)mapWd3.get("fsv");
		Map<String,Object> mapWd4 = makeKDA(sjId,ksrDaAnVo.getWdQuestId4(),ksrDaAnVo.getWdContent4(),"2",14);
		KsrDaAn wd4 = (KsrDaAn)mapWd4.get("kda");
		FenShuVo wdFsv4= (FenShuVo)mapWd4.get("fsv");
		Map<String,Object> mapWd5 = makeKDA(sjId,ksrDaAnVo.getWdQuestId5(),ksrDaAnVo.getWdContent5(),"2",15);
		KsrDaAn wd5 = (KsrDaAn)mapWd5.get("kda");
		FenShuVo wdFsv5= (FenShuVo)mapWd5.get("fsv");
		
		Map<String,Object> mapDt1 = makeKDA(sjId,ksrDaAnVo.getDtQuestId1(),ksrDaAnVo.getDtContent1(),"3",16);
		...
		list.add(dt1);
			...
			try {
				int j = ksrDaAnMapper.batchInsert(list);
				if(j<16){
		...
		int j;
		try {
			j = shiJuanMapper.updateByPrimaryKeySelective(shiJuan);
			if(j==0){
	...
	private Map<String, Object> makeKDA(String sjId,String questId ,String ksrContent ,String num,int shunXu){
